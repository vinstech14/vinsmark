            ...
            <div class="modal-content">
                ...
                <form action="../../functions/add_case.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="submit" class="btn btn-success sideback">Add Data</button>
                    </div>
                </form>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Court/Body:</label>
                                    <input type="text" class="form-control" name="ucourt" id="ucourt"
                                        placeholder="Court/Body">
                                </div>
                            </div>
                            <div class="row mb-3">
                    ...
                    ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-success deletebg deletebtn">DELETE</button>-->
